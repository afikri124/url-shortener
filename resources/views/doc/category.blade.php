                    ...
                    <div class="row g-2">
                        <div class="col-md-12 mb-0">
                            ...
                            <div class="select2-primary">
                                <select class="form-select select2-modalEdit" name="edit_aktivitas" id="edit_aktivitas">
                                    @foreach($user as $u)
    ...
    <form class="row p-3" method="POST" action="">
        ...
        <div class="col-md-4">
            ...
            <div class="input-group mb-3">
                <select class="form-select select2 @error('aktivitas') is-invalid @enderror" name="aktivitas" data-placeholder="-- Pilih Aktivitas --">
        ...
        <div class="col-md-8">
            <label class="form-label">Nama Kategori <i class="text-danger">*</i></label>
            <div class="input-group mb-3">
...
<script type="text/javascript">
    ...
    function CancelEdit() {
        ...
        $("#edit_aktivitas").trigger('change');
    }

    function EditId(id) {
        $.ajax({
            url: "{{ route('DOC.category_id') }}",
            type: "POST",
            data: {
                "id": id,
                "_token": $("meta[name='csrf-token']").attr("content"),
            ...
            success: function (data) {
                if (data['success']) {
                    $('#edit_id').val(id);
                    $('#edit_aktivitas').val(data['data'].activity_id).trigger("change");
    ...
    function SubmitEdit() {
        $.ajax({
            url: "{{ route('DOC.category_edit') }}",
            type: "POST",
            data: {
                "_token": $("meta[name='csrf-token']").attr("content"),
                "id": $('#edit_id').val(),
                "activity_id": $("#edit_aktivitas").val(),
                "name": $("#edit_nama").val(),
            },
            success: function (data) {
                if (data['success']) {
