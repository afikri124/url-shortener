...
<span class="text-muted fw-light">Pengaturan / Cuti atau Libur / </span>
@endsection
            ...
            <div class="card-body">
                <form action="" method="POST">
                    <div class="row">
                        ...
                        <div class="mb-3 col-md-6">
                            ...
                            <input type="text" class="form-control @error('nama') is-invalid @enderror" id="nama"
                                name="nama" value="{{ $data->detail }}" autofocus />
                            @error('nama')
                    ...
                    <div class="mt-2">
                        ...
                        <a class="btn btn-outline-secondary" href="{{ route('setting_public_holiday') }}">Kembali</a>
                    </div>
                </form>
            </div>
            <!-- /Account -->
