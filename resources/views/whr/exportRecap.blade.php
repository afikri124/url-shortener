    ...
    <table style="font-size: 11pt;">
        <thead>
            <tr>
                ...
                <td colspan="4" style="text-align: center;font-weight: bold;vertical-align: middle;">
            ...
            <tr>
                ...
                <th style="text-align: center;font-weight: bold;width:100px">Unit</th>
            </tr>
        </thead>
        <tbody>
            @php $nokey = 0; @endphp
            ...
            <tr>
                ...
                <td style="vertical-align: top;text-align:center">{{ $d->unit }}</td>
            </tr>
            @endforeach
        </tbody>
        <tfoot>
